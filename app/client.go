...
func (c *DDCSdkClient) GetNftService() *service.NftService {
	return service.NewDDCNftService()
}
...
func (d *DDCSdkClientBuilder) SetNft(ddc721Address string) *DDCSdkClientBuilder {
	if d.client == nil {
		d.client = &DDCSdkClient{}
	}
	d.client.nft = ddc721Address
	return d
}
