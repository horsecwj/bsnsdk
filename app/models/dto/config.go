...
func (c *ConfigInfo) DdcMyNFtAddress() common.Address {
	return c.myNftAddress
}
func (c *ConfigInfo) SetDdcMyNFtAddress(ddc721Address string) {
	c.myNftAddress = common.HexToAddress(ddc721Address)
}
